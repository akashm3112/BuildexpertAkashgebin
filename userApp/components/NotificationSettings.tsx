...
export default function NotificationSettings({ onClose }: NotificationSettingsProps) {
  ...
  const [config, setConfig] = useState({
    ...
    enableSound: true,
    vibrationIntensity: 'medium' as 'light' | 'medium' | 'heavy',
    soundType: 'default' as 'default' | 'success' | 'warning' | 'error'
  });
  ...
  const handleTestNotification = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Test Notification',
        'Notification test feature temporarily disabled due to plugin configuration issue.',
        [{ text: 'OK' }]
      );
    } catch (error) {
      Alert.alert(
