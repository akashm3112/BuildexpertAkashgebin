        ...
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
          {permissionStatus === 'denied' && (
            <View style={styles.permissionWarning}>
              ...
              <Text style={styles.permissionWarningText}>
                Push notifications are disabled. Enable them in device settings to receive booking updates.
              </Text>
            </View>
          )}

          <View style={styles.section}>
            <Text style={styles.sectionTitle}>Provider Notifications</Text>
            <Text style={styles.sectionDescription}>
              Stay updated on new bookings and customer interactions
            </Text>
          ...
          <View style={styles.section}>
            ...
            <SettingItem
              ...
              description="Receive updates about new features and business opportunities"
